...
model_args.output_dir = "tuned_roberta"
model_args.best_model_dir = "tuned_roberta/best_model"

useCuda =  True if torch.cuda.is_available() else False

# Create a TransformerModel
# Create a TransformerModel
model = SemevalModel('roberta', 'roberta-base', num_labels=3, use_cuda=useCuda, args=model_args)
