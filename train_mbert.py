...
model_args.output_dir = "tuned_mbert"
model_args.best_model_dir = "tuned_mbert/best_model"

useCuda =  True if torch.cuda.is_available() else False

# Create a TransformerModel
model = SemevalModel('bert', 'bert-base-multilingual-cased', num_labels=3, use_cuda=useCuda, args=model_args)
...
df.to_csv('data/submission_mbert.tsv', sep="\t", index=False)
